...
-w /usr/local/driveworks/apps/roadrunner-2.0/config ${ndas_image}  /home/entry.sh  

}



function run_drivesim {

CACHE_DIR=${siltest_dir}/cache/dockerovcache-dev
...
function watch_scenario_control_info {
