...
do
   ...
   echo  "======================= Run ndas container successfully ======================="
   ...
   echo  "======================= Run drivesim-ov container  successfully and begin to run $testcase ======================="
   
   # watch drivesim control info
   echo  "======================= Begin to listen control info =======================" 
   while true
       do
   ...
   echo "======================= Begin to execute the run_ndas.sh script ======================="
   ...
   echo "======================= drivesim-ov container has exited and begin to backup ======================="
    ...
    echo "======================= Begin to  generate evaluation report ======================="
...
echo "======================= Total successed case： $count ======================="
